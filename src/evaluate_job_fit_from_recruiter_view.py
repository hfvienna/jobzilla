...
Do not give arguments from the job description as source or for fit.
...
The applicant does not have the criteria from the job description unless stated in the CV.
"""
